...
import com.jpbelajar.web2.dto.CategoryData;
import com.jpbelajar.web2.dto.ResponseData;
import com.jpbelajar.web2.models.entities.Category;
import com.jpbelajar.web2.services.CategoryService;
...
public class CategoryController {
    ...
    @GetMapping("/{id}")
    public Category findOne(@PathVariable(name = "id") Long id){
    ...
    @DeleteMapping("/{id_cate}")
    public void removeOne(@PathVariable("id_cate") Long id) {
